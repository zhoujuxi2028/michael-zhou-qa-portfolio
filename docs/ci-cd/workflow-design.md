...
|---|---|---|---|---|
| 1 | AI Testing CI | `ai-testing-ci.yml` | AI 测试 | push / PR / dispatch |
...
| 10 | CICD Demo / Docker Nightly | `docker-tests.yml` | 集成测试 | schedule / dispatch |
| 11 | K8S Testing CI | `k8s-ci.yml` | K8s 测试 | push / PR / dispatch |
| 12 | Performance / Nightly | `nightly-soak.yml` | 性能压测 | schedule / dispatch |
...
| 15 | Security / Scan | `security-scan.yml` | 安全扫描 | push / PR / schedule / dispatch |
...
### 2.1 AI Testing CI — `ai-testing-ci.yml`
...
### 2.10 CICD Demo / Docker Nightly — `docker-tests.yml`
...
### 2.11 K8S Testing CI — `k8s-ci.yml`
...
### 2.12 Performance / Nightly — `nightly-soak.yml`
...
### 2.15 Security / Scan — `security-scan.yml`
