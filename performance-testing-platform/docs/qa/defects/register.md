...
| DEF-023   | [PR #276](https://github.com/zhoujuxi2028/michael-zhou-qa-portfolio/pull/276) | BATS 9.1 分支白名单缺少 `docs/` 前缀，PR #276 CI 红灯 | P2 / Medium | ✅ Blocking (PR)  | 2026-05-26 | 🟡 Fix in review | —           | `stage4-selftest-fast.bats` 第 144 行 pattern 未包含 `docs/`；`docs/qa-cicd-scenarios-and-reorganise` 曾是有效分支但被拒；修复：加入 `docs/` 至白名单 |
