...
| --------- | ----------- | ---------- | ------------------------------------------------------------------------------------------------------------- | ---------------- | ---------- | ---------- | ------------------- | --------- |
| WAV-001   | DEF-002     | #193       | `version` 字段为废弃 warning，Docker Compose 已忽略该字段，容器行为不受影响；已随 #193 修复直接删除         | 极低：无功能影响 | QA         | 2026-04-24 | —                   | ✅ 已关闭 |
...
| --------- | ---------------------------------------------------------------------------- | -------------------------------------------------------- | ------ | ---------- | ------------------------------------------------------------ | ---------------------------------- |
| DEF-001   | [#192](https://github.com/zhoujuxi2028/michael-zhou-qa-portfolio/issues/192) | Grafana readiness 超时                                   | P1     | 2026-04-24 | 代码修复（healthcheck + timeout 120s）                       | fix/issue-192-193                  |
| DEF-002   | [#193](https://github.com/zhoujuxi2028/michael-zhou-qa-portfolio/issues/193) | docker-compose.yml version 字段过时                      | P3     | 2026-04-24 | 代码修复（删除 version 字段）                                | fix/issue-192-193                  |
