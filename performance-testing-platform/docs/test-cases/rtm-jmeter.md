...
| 需求 ID | 需求 | 设计文件 | 测试用例 ID | 状态 |
|---------|------|---------|------------|------|
| US-12 | 最大并发承载量 | `tests/performance/capacity.k6.js` | CAP-05 | PASS (最大 ~6000 VUs，二分法进行中) |
...
| **Inflection Point** | **6000~6500 VUs 之间** (6000 PASS，6500 FAIL; 二分法进行中 → 下一步 6250 VUs) |
| **稳定 FAIL** | ≥ 6500 VUs — p95 超标 (628ms@6500, 659ms@7000) |
| **最大安全容量** | **~6000 VUs** (暂定，待 6250 VUs 二分法确认) |
| **吞吐量天花板** | ~6,800 req/s (6000~6500 VUs 吞吐趋同: 6,796 vs 6,802) |
