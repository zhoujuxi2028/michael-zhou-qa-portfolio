...
| **Inflection Point** | **6000~6250 VUs 之间** (6000 PASS p95=490ms，6250 FAIL p95=512ms; 下一步 6125 VUs) |
| **稳定 FAIL** | ≥ 6250 VUs — p95 超标 (512ms@6250, 628ms@6500, 659ms@7000) |
| **最大安全容量** | **~6000 VUs** (暂定，二分法逼近 6000~6250 区间) |
| **吞吐量天花板** | ~7,000 req/s (6250 VUs 时 7,015 req/s，趋近饱和) |
